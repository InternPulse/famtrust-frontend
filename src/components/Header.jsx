...
const Header = () => {
  ...
  return (
    <div className={`py-4 ${clickShow && ' overflow-hidden'} `}>
      ...
      <div
        className={`md:hidden flex flex-col text-center px-6 h-screen mt-4 transition-all py-4 bg-black text-white ${
          show ? 'block' : 'hidden'
        }`}
      >
        <div onClick={closeShow} className="flex flex-col py-6 ">
          ...
          <HashLink smooth className="py-4" to="#services">
            Services
          </HashLink>
          <HashLink smooth className="py-4" to="#resources">
            Resources
          </HashLink>
        ...
        <div onClick={closeShow} className="flex flex-col py-4 ">
          ...
          <NavLink
            className="bg-bluey px-3 py-4 rounded-lg text-white"
            to="signup"
          >
            <button>Sign Up</button>
          </NavLink>
